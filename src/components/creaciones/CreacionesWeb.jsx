    ...
    <>
      <figure className="col-span-1 lg:col-span-2 text-center">
        ...
        <p className="text-balance font-normal text-gray-500 w-auto lg:w-[300px] lg:m-auto">
          ...
          <span className="text-gray-200 font-light">Desarrollo Web</span>.
        </p>
      </figure>
      ...
      <figure className="group text-center">
        <Image
          ...
          height={500}
          priority
          className="border-2 border-dotted  opacity-60 hover:opacity-100 border-gray-600 hover:border-gray-400 rounded-md cursor-pointer"
        />
